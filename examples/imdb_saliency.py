...
io = gradio.Interface(inputs=textbox, outputs=label, model_type="keras", model=model, saliency=saliency)httpd, path_to_local_server, share_url = io.launch(share=True, inbrowser=True)
