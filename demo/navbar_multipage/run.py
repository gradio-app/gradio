...
with gr.Blocks(title="Navbar Demo") as demo:
    ...
    hide_btn.click(fn=lambda : gr.Navbar(visible=False, home_page_title="Dashboard"), outputs=navbar)
    show_btn = gr.Button("Show Navbar")
    show_btn.click(fn=lambda : gr.Navbar(visible=True, home_page_title="Testings"), outputs=navbar)
