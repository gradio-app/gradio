...
gr.Interface(lambda x,y,z:(x,y,z), 
             ["textbox","image", "textbox", "textbox", "image","image","image","image","image"], 
             ["textbox","image", "textbox", "textbox", "image","image","image","image","image"], 
             examples=[["abc","./files/cheetah1.jpg", "test a very long string here to see if it wraps or not test a very long string here to see if it wraps or not test a very long ", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg"],["abc","./files/cheetah1.jpg", "test a very long string here to see if it wraps or not test a very long string here to see if it wraps or not test a very long ", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg"],["abc","./files/cheetah1.jpg", "test a very long string here to see if it wraps or not test a very long string here to see if it wraps or not test a very long ", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg"],["abc","./files/cheetah1.jpg", "test a very long string here to see if it wraps or not test a very long string here to see if it wraps or not test a very long ", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg", "./files/cheetah1.jpg"]]).launch()
