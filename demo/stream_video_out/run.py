...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        [[os.path.join(os.path.dirname(__file__), "video/compliment_bot_screen_recording_3x.mp4"), False],
            [os.path.join(os.path.dirname(__file__), "video/compliment_bot_screen_recording_3x.mp4"), True]],
