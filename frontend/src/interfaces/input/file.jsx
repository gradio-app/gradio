...
class FileInput extends React.Component {
      ...
      return (
        <div className="input_file">
          <div className="file_preview_holder">
            ...
            <div className="file_size">{file_size === null ? "" : prettyBytes(file_size)}</div>
          </div>
        </div>)
    } else {
      return (
      <div className="input_file" onDrag={no_action} onDragStart={no_action} onDragEnd={no_action} onDragOver={no_action} onDragEnter={no_action} onDragLeave={no_action} onDrop={no_action} >
  ...
  load_preview_from_files(files) {
    ...
    for (let file of files) {
      ...
      ReaderObj.onloadend = this.add_file_to_list.bind(this, ReaderObj, file, files.length);
    }
  }
}
