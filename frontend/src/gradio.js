...
import TextboxInput from './interfaces/input/textbox.js';
import ImageInput from './interfaces/input/image.js';
import TextboxOutput from './interfaces/output/textbox.js';
import LabelOutput from './interfaces/output/label.js';
...
class GradioInterface extends React.Component {
  constructor(props) {
    super(props);
