...
- The `type` and `plot` parameter deprecation warnings should now only be emitted for `Textbox` and `Image` components by [@freddyaboulton](https://github.com/freddyaboulton) in [PR 4709](https://github.com/gradio-app/gradio/pull/4709)
