...
- `start_server` and `App.create_app()` now accept an `app_kwargs` argument to allow customizing the FastAPI app, by [@akx](https://github.com/akx) in [PR 4282](https://github.com/gradio-app/gradio/pull/4282)
