...
## Bug Fixes:
- Fix duplicate play commands in full-screen mode of 'vidieo'. by [@tomchang25](https://github.com/tomchang25) in [PR 3968](https://github.com/gradio-app/gradio/pull/3968).
