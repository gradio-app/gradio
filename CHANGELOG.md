...
6. Fix audio streaming, which was previously choppy in [PR 2351](https://github.com/gradio-app/gradio/pull/2291). Big thanks to [@yannickfunk](https://github.com/yannickfunk) for the propsed solution.
