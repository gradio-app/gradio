...
- gradio-ui -> `Image` components mode is `mask` or `color-sketch`, click undo not get right result real time, by [@amyorz](https://github.com/AmyOrz) in [PR 4692](https://github.com/gradio-app/gradio/pull/4692)
