...
- Fixes bug where interactive output image cannot be set when in edit mode by [@dawoodkhan82](https://github.com/freddyaboulton) in [PR 3128](https://github.com/gradio-app/gradio/pull/3128)
