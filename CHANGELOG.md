...
* Clearer error message when events are defined outside of a Blocks scope by [@abidlabs](https://github.com/abidlabs) in [PR 2528](https://github.com/gradio-app/gradio/pull/2528)
