...
- Ensure the Video component correctly resets the UI state whe a new video source is loaded by [@pngwn](https://github.com/abidlabs) in [PR 3117](https://github.com/gradio-app/gradio/pull/3117)
