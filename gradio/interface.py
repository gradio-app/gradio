    ...
    def __init__(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            cache_examples: if True, caches examples in the server for fast runtime in examples. If `fn` is a generator function, then the last yielded value will be used as the output. Can also be set by the GRADIO_CACHE_EXAMPLES environment variable, which takes a case-insensitive value, one of: {"true", "false"}. The default option in HuggingFace Spaces is True. The default option elsewhere is False.
