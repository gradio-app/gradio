    ...
    def __init__(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            article: An expanded article explaining the interface; if provided, appears below the input and output components in regular font. Accepts Markdown and HTML content. If it is a link to an HTTP(S) remote file, the content is downloaded.
