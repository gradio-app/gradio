...
class Interface(Blocks):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Parameters:
            fn: the function to wrap an interface around. Often a machine learning model's prediction function. If batch is True, the function must accept a *nested* list of inputs, where the outer list represents the batch, and the inner list represents the inputs to the function. For example, if the function takes two inputs, the input to the function would be [[input1, input2], [input1, input2], [input1, input2]]. Similarly, the function must return a *nested* list of outputs. For example, if the function returns one output, the output of the function should be [[output1], [output1], [output1]].
