...
class GradioMCPServer:
    ...
    def create_mcp_server(self, mcp_server: FastMCP | Literal[True] = True) -> Server:
        ...
        Parameters:
            mcp_server: If True, create a new MCP server from the functions in the Gradio Blocks app. If a FastMCP instance is provided, extract the tools, resources, and prompts from the FastMCP server and add them to the Gradio MCP server.
