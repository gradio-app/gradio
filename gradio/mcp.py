...
class GradioMCPServer:
    ...
    def _file_data_tool_description(self) -> str:
        ...
        """
        return " If a user passes a file as an input, use the upload_file_to_gradio_or_hf tool, if present, to upload the file to the gradio app and create a Gradio File Input. Then use the returned path as the input to the tool"
