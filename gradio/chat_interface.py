    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            api_description: Description of the API endpoint. Can be a string, None, or False.If set to a string, the endpoint will be exposed in the API docs with the given description.If set to None, the function's docstring will be used as the API endpoint description.If the function overrides a method from a parent class and does not define its own docstring,the docstring will be automatically inherited from the parent using `inspect.getdoc()`.If set to False, no description will be displayed in the API docs.
