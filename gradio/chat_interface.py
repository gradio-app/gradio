    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            flagging_options: a list of strings representing the options that users can choose from when flagging a message. Defaults to ["Like", "Dislike"].
        ...
        if flagging_mode in ["manual", "never", "auto"]:
