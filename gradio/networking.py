...
def setup_tunnel(
    local_host: str, local_port: int, share_token: str, share_server_address: str | None, share_server_tls_certificate: str | None
) -> str:
    ...
    tunnel = Tunnel(remote_host, remote_port, local_host, local_port, share_token, share_server_tls_certificate)
