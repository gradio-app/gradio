...
class Examples:
    ...
    Guides: more-on-examples-and-flagging, using-hugging-face-integrations, image-classification-in-pytorch, image-classification-in-tensorflow, image-classification-with_vision_transformers, create_your_own_friends_with_a_gan
    """
