    ...
    def launch(
        ...
        *,
        ...
        Parameters:
            ...
            enable_monitoring: Enables traffic monitoring of the app through the /monitoring endpoint, enabled by default. If True, will print the monitoring URL to the console. If False, will disable monitoring.
        Returns:
