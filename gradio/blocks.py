...
class BlockFunction:
    def __init__(
        self,
        fn: Callable | None,
        inputs: Sequence[Component] | Sequence[BlockContext],
        outputs: Sequence[Component] | Sequence[BlockContext],
        preprocess: bool,
        postprocess: bool,
        inputs_as_dict: bool,
...
class BlocksConfig:
    ...
    def set_event_trigger(
        ...
        fn: Callable | None,
        inputs: Component | Sequence[Component] | AbstractSet[Component] | BlockContext | Sequence[BlockContext] | AbstractSet[BlockContext] | None,
        outputs: Component | Sequence[Component] | AbstractSet[Component] | BlockContext | Sequence[BlockContext] | AbstractSet[BlockContext] | None,
