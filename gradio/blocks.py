...
class BlocksConfig:
    ...
    def set_event_trigger(
        ...
        Parameters:
            ...
            api_description: Description of the API endpoint. Can be a string or None. If set to a string, the endpoint will be exposed in the API docs with the given description. If None, the function's docstring will be used as the API endpoint description.
