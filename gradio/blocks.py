    ...
    def __init__(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            expand_to_height: Whether to vertically expand top-level child components to the height of the window. If True, expansion occurs when the scale value of the child components >= 1.
        """
        self.limiter = None
        if theme is None:
            theme = DefaultTheme()
        ...
        self.head = head
        self.expand_to_height = expand_to_height
...
Received outputs:
    ...
    def get_config_file(self):
        config = {
            ...
            "expand_to_height": self.expand_to_height,
        }
