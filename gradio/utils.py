...
def get_heartbeat_rate() -> float:
    ...
    number of seconds). A shorter interval is useful in environments such as
    Kubernetes, where the default 15 seconds can delay the detection of client
    disconnections. If the variable is unset (or invalid), falls back to 0.25
    seconds during end-to-end tests and 15 seconds otherwise.
    """
