...
/* Users/peterallen/Projects/gradio/js/checkboxgroup/interactive/InteractiveCheckboxgroup.svelte generated by Svelte v4.0.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('InteractiveCheckboxgroup', slots, []);
	let { gradio } = $$props;
	let { elem_id = "" } = $$props;
	...
	$$self.$$.on_mount.push(function () {
		if (gradio === undefined && !('gradio' in $$props || $$self.$$.bound[$$self.$$.props['gradio']])) {
			console.warn("<InteractiveCheckboxgroup> was created without expected prop 'gradio'");
		}

		if (choices === undefined && !('choices' in $$props || $$self.$$.bound[$$self.$$.props['choices']])) {
			console.warn("<InteractiveCheckboxgroup> was created without expected prop 'choices'");
		}

		if (show_label === undefined && !('show_label' in $$props || $$self.$$.bound[$$self.$$.props['show_label']])) {
			console.warn("<InteractiveCheckboxgroup> was created without expected prop 'show_label'");
		}

		if (loading_status === undefined && !('loading_status' in $$props || $$self.$$.bound[$$self.$$.props['loading_status']])) {
			console.warn("<InteractiveCheckboxgroup> was created without expected prop 'loading_status'");
		}
	});
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<InteractiveCheckboxgroup> was created with unknown prop '${key}'`);
	});
...
class InteractiveCheckboxgroup extends SvelteComponentDev {
	constructor(options) {
		super(options);
		...
		dispatch_dev("SvelteRegisterComponent", {
			component: this,
			tagName: "InteractiveCheckboxgroup",
			options,
			id: create_fragment.name
		});
	}
	...
	get gradio() {
		throw new Error("<InteractiveCheckboxgroup>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set gradio(value) {
		throw new Error("<InteractiveCheckboxgroup>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
...
const InteractiveCheckboxgroup$1 = InteractiveCheckboxgroup;

export { InteractiveCheckboxgroup$1 as default };
//# sourceMappingURL=index-c5bbf580.js.map
