...
/* Users/peterallen/Projects/gradio/js/radio/interactive/InteractiveRadio.svelte generated by Svelte v4.0.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('InteractiveRadio', slots, []);
	let { gradio } = $$props;
	...
	$$self.$$.on_mount.push(function () {
		if (gradio === undefined && !('gradio' in $$props || $$self.$$.bound[$$self.$$.props['gradio']])) {
			console.warn("<InteractiveRadio> was created without expected prop 'gradio'");
		}

		if (show_label === undefined && !('show_label' in $$props || $$self.$$.bound[$$self.$$.props['show_label']])) {
			console.warn("<InteractiveRadio> was created without expected prop 'show_label'");
		}

		if (loading_status === undefined && !('loading_status' in $$props || $$self.$$.bound[$$self.$$.props['loading_status']])) {
			console.warn("<InteractiveRadio> was created without expected prop 'loading_status'");
		}
	});
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<InteractiveRadio> was created with unknown prop '${key}'`);
	});
...
class InteractiveRadio extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get gradio() {
		throw new Error("<InteractiveRadio>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set gradio(value) {
		throw new Error("<InteractiveRadio>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
...
const InteractiveRadio$1 = InteractiveRadio;

export { InteractiveRadio$1 as default };
//# sourceMappingURL=index-c15a82ec.js.map
