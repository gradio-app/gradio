...
/* Users/peterallen/Projects/gradio/js/checkbox/interactive/InteractiveCheckbox.svelte generated by Svelte v4.0.0 */
...
function create_default_slot_1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*info*/ 128) set_data_dev(t, /*info*/ ctx[7]);
		},
		d: function destroy(detaching) {
			if (detaching) {
				detach_dev(t);
...
function create_default_slot(ctx) {
	...
	let if_block = /*info*/ ctx[7] && create_if_block(ctx);
	...
	let checkbox_props = { label: /*label*/ ctx[6] };
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			const statustracker_changes = (dirty & /*gradio, loading_status*/ 2052)
			...
			if (dirty & /*label*/ 64) checkbox_changes.label = /*label*/ ctx[6];
...
function create_fragment(ctx) {
	...
	const block_1 = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, label, value, value_is_output, gradio, info, loading_status*/ 133319) {
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('InteractiveCheckbox', slots, []);
	let { gradio } = $$props;
	let { elem_id = "" } = $$props;
	...
	let { label = gradio.i18n("checkbox.checkbox") } = $$props;
	...
	$$self.$$.on_mount.push(function () {
		if (gradio === undefined && !('gradio' in $$props || $$self.$$.bound[$$self.$$.props['gradio']])) {
			console.warn("<InteractiveCheckbox> was created without expected prop 'gradio'");
		}

		if (loading_status === undefined && !('loading_status' in $$props || $$self.$$.bound[$$self.$$.props['loading_status']])) {
			console.warn("<InteractiveCheckbox> was created without expected prop 'loading_status'");
		}
	});
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<InteractiveCheckbox> was created with unknown prop '${key}'`);
	});
...
class InteractiveCheckbox extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get gradio() {
		throw new Error("<InteractiveCheckbox>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set gradio(value) {
		throw new Error("<InteractiveCheckbox>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
...
const InteractiveCheckbox$1 = InteractiveCheckbox;

export { InteractiveCheckbox$1 as default };
//# sourceMappingURL=index-263439c2.js.map
