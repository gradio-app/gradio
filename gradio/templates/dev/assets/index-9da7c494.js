...
/* Users/peterallen/Projects/gradio/js/number/example/Number.svelte generated by Svelte v4.0.0 */

const file = "Users/peterallen/Projects/gradio/js/number/example/Number.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(/*value*/ ctx[0]);
			attr_dev(div, "class", "s-qeNOFE6kpfp9");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.on_mount.push(function () {
		...
		if (type === undefined && !('type' in $$props || $$self.$$.bound[$$self.$$.props['type']])) {
			console.warn("<Number> was created without expected prop 'type'");
		}
	});
...
export { Number$1 as default };
//# sourceMappingURL=index-9da7c494.js.map
