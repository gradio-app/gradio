...
/* Users/peterallen/Projects/gradio/js/textbox/interactive/InteractiveTextbox.svelte generated by Svelte v4.0.0 */

// (41:1) {#if loading_status}
...
// (32:0) <Block  {visible}  {elem_id}  {elem_classes}  {scale}  {min_width}  allow_overflow={false}  padding={container} >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(32:0) <Block  {visible}  {elem_id}  {elem_classes}  {scale}  {min_width}  allow_overflow={false}  padding={container} >",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block_1 = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*label, info, show_label, lines, type, rtl, text_align, max_lines, placeholder, show_copy_button, autofocus, container, autoscroll, value, value_is_output, gradio, loading_status*/ 4144927 | dirty[1] & /*$$scope*/ 1) {
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('InteractiveTextbox', slots, []);
	const dispatch = createEventDispatcher();
	let { gradio = { dispatch, i18n: s => s } } = $$props;
	...
	$$self.$$.on_mount.push(function () {
		if (lines === undefined && !('lines' in $$props || $$self.$$.bound[$$self.$$.props['lines']])) {
			console.warn("<InteractiveTextbox> was created without expected prop 'lines'");
		}

		if (show_label === undefined && !('show_label' in $$props || $$self.$$.bound[$$self.$$.props['show_label']])) {
			console.warn("<InteractiveTextbox> was created without expected prop 'show_label'");
		}

		if (max_lines === undefined && !('max_lines' in $$props || $$self.$$.bound[$$self.$$.props['max_lines']])) {
			console.warn("<InteractiveTextbox> was created without expected prop 'max_lines'");
		}
	});
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<InteractiveTextbox> was created with unknown prop '${key}'`);
	});
...
class InteractiveTextbox extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
export { InteractiveTextbox as I };
//# sourceMappingURL=InteractiveTextbox-a07b20ba.js.map
