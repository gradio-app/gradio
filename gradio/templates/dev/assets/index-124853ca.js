...
/* Users/peterallen/Projects/gradio/js/model3D/example/Model3d.svelte generated by Svelte v4.0.0 */

const file = "Users/peterallen/Projects/gradio/js/model3D/example/Model3d.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(/*value*/ ctx[0]);
			attr_dev(div, "class", "s-0tDA1-Zo_hzb");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.on_mount.push(function () {
		...
		if (type === undefined && !('type' in $$props || $$self.$$.bound[$$self.$$.props['type']])) {
			console.warn("<Model3d> was created without expected prop 'type'");
		}
	});
...
export { Model3d$1 as default };
//# sourceMappingURL=index-124853ca.js.map
