...
class NativePlot(Component):
    ...
    def __init__(
        ...
        *,
        ...
        y_lim: list[float] | Literal["origin"] | None = None,
        ...
        **kwargs,
        ...
        Parameters:
            ...
            y_lim: A tuple of list containing the limits for the y-axis, specified as [y_min, y_max]. If set to "origin", will set the y-axis to start at 0.
