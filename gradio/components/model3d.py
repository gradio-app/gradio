    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_mode: the display mode of the 3D model in the scene. Can be "solid" (which renders the model as a solid object), "point_cloud", or "wireframe". For .splat files and Gaussian Splat .ply files, this parameter is ignored. For regular point cloud .ply files, all display modes are supported.
