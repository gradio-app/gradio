    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_mode: the display mode of the 3D model in the scene. Can be "solid" (which renders the model as a solid object), "point_cloud", or "wireframe". For .splat and .ply files, this parameter is ignored and point cloud mode is used automatically.
