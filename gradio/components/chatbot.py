    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            watermark: If provided, this text will be appended to the end of messages copied from the chatbot. Useful for indicating that the message is generated by an AI model.
