...
class Chatbot(Changeable, Selectable, IOComponent, JSONSerializable):
    ...
    def __init__(
        ...
        *,
        ...
        show_chat_copy_button: bool | None = None,
        **kwargs,
    ):
        """
        Parameters:
            ...
            show_chat_copy_button: If True, will show a copy button for each chatbot answer.
        """
        ...
        self.show_chat_copy_button = show_chat_copy_button
    ...
    def get_config(self):
        return {
            ...
            "rtl": self.rtl,
            "show_chat_copy_button": self.show_chat_copy_button,
    ...
    def update(
        ...
        updated_config = {
            ...
            "rtl": rtl,
            "show_chat_copy_button": show_chat_copy_button,
            "__type__": "update",
        }
