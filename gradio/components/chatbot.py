    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_consecutive_in_same_bubble: If True, will display consecutive messages from the same role in the same bubble. If False, will display each message in a separate bubble. Defaults to True.
        """
        if type is None:
            warnings.warn(
        ...
        self.rtl = rtl
        self.display_consecutive_in_same_bubble = display_consecutive_in_same_bubble
