    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            buttons: A list of buttons to show in the top right corner of the component. Valid options are "share", "copy", and "copy_all". The "share" button allows the user to share outputs to Hugging Face Spaces Discussions. The "copy" button allows the user to copy individual chatbot messages. The "copy_all" button allows the user to copy all chatbot messages. By default, no buttons are shown.
