    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            buttons: A list of buttons to show in the top right corner of the component. Valid options are "share", "download", and "fullscreen". The "share" button allows the user to share outputs to Hugging Face Spaces Discussions. The "download" button allows the user to download the selected image. The "fullscreen" button allows the user to view the gallery in fullscreen mode. By default, no buttons are shown.
