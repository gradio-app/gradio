    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            variant: 'primary' for main call-to-action, 'secondary' for a more subdued style, 'stop' for a stop button, 'huggingface' for a black background with white text, consistent in both light and dark modes, following Hugging Face branding.
