    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            slider_position: The position of the slider as a percentage of the width of the image, between 0 and 100. As the user drags the slider, this value is updated to reflect the current position, so a function whose parameter is annotated with `gr.ImageSlider` reads the live position.
