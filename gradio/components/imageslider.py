    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            buttons: A list of buttons to show in the top right corner of the component. Valid options are "download" and "fullscreen". The "download" button allows the user to download the image. The "fullscreen" button allows the user to view the image in fullscreen mode. By default, no buttons are shown.
