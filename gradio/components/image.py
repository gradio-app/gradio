    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            watermark: A PIL Image, numpy array, or path to an image to be displayed on the bottom right of the image. Valid tested file formats for the image are: jpeg, png, bmp, webp.
        """
        self.format = format
