    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            buttons: A list of buttons to show for the component. Valid option is "copy". The "copy" button allows the user to copy the text in the textbox. Only applies if show_label is True. By default, no buttons are shown.
