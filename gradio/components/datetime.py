...
class DateTime(FormComponent):
    ...
    def __init__(
        ...
        *,
        ...
        self._value_description = "a datetime object" if self.type == "datetime" else "a unix timestamp" if self.type == "timestamp" else "a %Y-%m-%d %H:%M:%S formatted string" if include_time else "a %Y-%m-%d formatted string"
