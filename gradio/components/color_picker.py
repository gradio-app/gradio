...
class ColorPicker(Component):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            value: default text to provide in color picker. If a function is provided, the function will be called each time the app loads to set the initial value of this component.
