    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            image_mode: The pixel format and color depth that the images are converted to. The default "RGBA" keeps the alpha channel of a transparent image, "RGB" drops it, and "L" converts to black-and-white. See https://pillow.readthedocs.io/en/stable/handbook/concepts.html for the other supported image modes and their meaning.
            ...
            type: The format the images are converted to before being passed into the prediction function. "numpy" converts the images to numpy arrays with values from 0 to 255 and shape (height, width, channels), where the channel count follows `image_mode` and is 4 for the default "RGBA", "pil" converts the images to PIL image objects, "filepath" passes images as str filepaths to temporary copies of the images.
