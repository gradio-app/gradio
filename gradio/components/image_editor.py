    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            buttons: A list of buttons to show in the corner of the component. Valid options are "download" to download the image, "share" to share to Hugging Face Spaces Discussions, and "fullscreen" to view in fullscreen mode. By default, shows ["download", "fullscreen"] if the component is not interactive and [] if it is interactive.
