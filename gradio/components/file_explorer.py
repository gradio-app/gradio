    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            file_count: Whether to allow a single file or folder, or multiple files, to be selected. If "single", the component will return a single absolute file or folder path as a string. If "multiple", the component will return a list of absolute file paths as a list of strings.
