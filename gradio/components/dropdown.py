    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            max_values_shown: maximum number of matching choices to display in the dropdown at once. Additional choices remain searchable when `filterable` is True. If None, all matching choices are shown.
