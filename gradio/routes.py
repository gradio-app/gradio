...
class App(FastAPI):
    ...
    def create_app(
        ...
        # Session Middleware requires a secret key to sign the cookies. Let's use a hash of the OAuth secret key to
        # make it unique to the Space + updated in case OAuth config gets updated.
        app.add_middleware(
            SessionMiddleware,
