...
evergreen_green = Color(
    name="evergreen_green",
    c50="#edfcf2",
    c100="#d3f9e0",
    c200="#aaf0c6",
    c300="#6ee3a3",
...
evergreen_neutral = Color(
    name="evergreen_neutral",
    c50="#f4f7f5",
    c100="#e6ebe8",
    c200="#d0d9d3",
    c300="#adbab2",
...
class Evergreen(Base):
    def __init__(
        self,
        *,
        primary_hue: colors.Color | str = evergreen_green,
        secondary_hue: colors.Color | str = colors.emerald,
        neutral_hue: colors.Color | str = evergreen_neutral,
        spacing_size: sizes.Size | str = sizes.spacing_md,
        radius_size: sizes.Size | str = sizes.radius_md,
        text_size: sizes.Size | str = sizes.text_md,
        font: fonts.Font | str | Iterable[fonts.Font | str] = (
            fonts.GoogleFont("Plus Jakarta Sans", weights=(400, 500, 600, 700)),
            "ui-sans-serif",
            "system-ui",
            "sans-serif",
        ),
        ...
        super().set(
            ...
            # Backgrounds
            background_fill_primary="#f8faf9",
            background_fill_primary_dark="*neutral_900",
            background_fill_secondary="*neutral_100",
            background_fill_secondary_dark="*neutral_800",
            # Shadows
            shadow_drop="0 1px 4px rgba(10, 77, 45, 0.06)",
            shadow_drop_lg="0 4px 16px rgba(10, 77, 45, 0.08)",
            shadow_spread="6px",
            ...
            input_shadow="none",
            input_shadow_focus="0 0 0 3px rgba(19, 180, 95, 0.15)",
            input_shadow_focus_dark="0 0 0 3px rgba(19, 180, 95, 0.25)",
            ...
            button_primary_shadow="0 2px 6px rgba(19, 180, 95, 0.25)",
            button_primary_shadow_hover="0 4px 12px rgba(19, 180, 95, 0.35)",
            button_primary_shadow_active="0 1px 3px rgba(19, 180, 95, 0.2)",
            button_primary_shadow_dark="0 2px 6px rgba(19, 180, 95, 0.15)",
            button_primary_shadow_hover_dark="0 4px 12px rgba(19, 180, 95, 0.25)",
            button_primary_shadow_active_dark="0 1px 3px rgba(19, 180, 95, 0.1)",
            ...
            button_secondary_border_color_dark="*primary_800",
