    ...
    def __init__(
        ...
        *,
        ...
        super().set(
            ...
            # Gradients
            stat_background_fill="linear-gradient(to right, *primary_400, *secondary_500)",
            stat_background_fill_dark="linear-gradient(to right, *primary_500, *secondary_700)",
            ...
            # Primary Button
            button_primary_background_fill="linear-gradient(-15deg, *primary_500, *secondary_500)",
            button_primary_background_fill_dark="linear-gradient(-15deg, *primary_600, *secondary_600)",
            button_primary_background_fill_hover="linear-gradient(-15deg, *primary_600, *secondary_600)",
            button_primary_background_fill_hover_dark="linear-gradient(-15deg, *primary_700, *secondary_700)",
