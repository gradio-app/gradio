    ...
    def __init__(
        ...
        *,
        ...
        super().set(
            ...
            button_shadow_hover="0px 5px 0px 0px var(--primary-300);",
            button_shadow="0px 3px 0px 0px var(--primary-300);",
            button_shadow_active="0px 2px 0px 0px var(--primary-300);",
            input_shadow="0px -1px 0px 0px var(--neutral-300);",
            input_shadow_focus="0px -1px 0px 0px var(--primary-300);",
            input_background_fill="*neutral_50",
            input_background_fill_focus="*primary_50",
            block_shadow="0px 3px 0px 0px var(--neutral-300);",
            ...
            button_shadow_hover_dark="0px 5px 0px 0px var(--primary-600);",
            button_shadow_dark="0px 3px 0px 0px var(--primary-600);",
            button_shadow_active_dark="0px 2px 0px 0px var(--primary-600);",
            input_shadow_dark="0px -1px 0px 0px var(--neutral-700);",
            input_shadow_focus_dark="0px -1px 0px 0px var(--primary-600);",
            input_background_fill_dark="*neutral_900",
            input_background_fill_focus_dark="none",
            block_shadow_dark="0px 3px 0px 0px var(--neutral-900);",
