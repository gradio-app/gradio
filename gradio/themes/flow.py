    ...
    def __init__(
        ...
        *,
        ...
        super().set(
            ...
            input_border_color_base="*neutral_50",
            ...
            button_primary_background_base="*primary_500",
            button_primary_background_hover="*primary_400",
            button_primary_text_color_base="white",
            button_secondary_background_base="white",
            button_secondary_background_hover="*neutral_100",
            button_secondary_text_color_base="*neutral_800",
            button_cancel_background_base="*button_secondary_background_base",
            ...
            checkbox_label_background_base="white",
            checkbox_label_background_selected="*primary_500",
            checkbox_label_background_selected_dark="*primary_600",
            checkbox_border_width="1px",
            checkbox_border_color_base="*neutral_100",
            checkbox_border_color_base_dark="*neutral_600",
            ...
            checkbox_color_text_selected="white",
            # Borders
