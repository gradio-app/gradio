    ...
    def __init__(
        ...
        *,
        ...
        super().set(
            ...
            button_primary_background_dark="linear-gradient(to bottom right, *primary_500, *primary_600)",
            button_primary_background_hover="linear-gradient(to bottom right, *primary_100, *primary_200)",
            button_primary_background_hover_dark="linear-gradient(to bottom right, *primary_500, *primary_500)",
