	...
	<div class="flex border-b-2">
		{#each tabs as t, i}
			{#if t.id === $selected_tab}
				<button
					class="bg-white px-4 pb-2.5 pt-2 rounded-t-lg border-gray-200 -mb-[2px] border-2 border-b-0"
				>
					{t.name}
				</button>
			{:else}
				<button
					class="px-4 pb-2.5 pt-2 border-transparent text-gray-400 hover:text-gray-700 -mb-[2px] border-2 border-b-0"
