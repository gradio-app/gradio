<script>
  ...
  <MetaTags title={"Gradio Combining Interfaces Docs"} 
...
<main class="container mx-auto px-4 flex gap-4">
    ...
    <DocsNav current_nav_link={"combining-interfaces"} components={components} helpers={helpers} routes={routes} />
    ...
    <div class="flex flex-col w-full min-w-full	lg:w-10/12 lg:min-w-0">
        ...
        <div class="flex justify-between mt-4">
            ...
            <div class="text-lg"><span class="text-orange-500">&#8592;</span> Flagging</div>
            </a>
            <a href="/docs/blocks"
        ...
        <div class="flex flex-row items-center justify-between"> 
            ...
            <a href="#combining-interfaces-header" class="invisible group-hover-visible"><img class="anchor-img" src="{anchor}"/></a>
            </h3>
        </div>
...
<div class="float-right mt-10 hidden lg:block ">
    <div class='fixed'>
      <div class="px-8">
        <a class="thin-link py-2 block text-lg second-nav-link current-nav-link" href="combining-interfaces">Combining Interfaces</a>
        {#if headers.length > 0}
