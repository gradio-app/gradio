...
The `Example.svelte` and `as_example` methods will be covered in greater depth in the dedicated [frontend](/main/guides/frontend) and [backend](/main/guides/backend) guides.
