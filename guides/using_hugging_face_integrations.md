...
You can learn more about this feature, and how to use it with the new Blocks API in the [Treating Gradio Apps Like Functions guide](/using_apps_like_functions)
