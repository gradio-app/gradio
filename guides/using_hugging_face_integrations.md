...
You can learn more about this feature, and how to use it with the new Blocks API in the [Treating Gradio apps like functions guide](/using_blocks_like_functions/)
