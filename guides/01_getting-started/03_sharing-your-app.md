...
1. From terminal: run `gradio deploy` in your app directory. The CLI will gather some basic metadata and then launch your app. Whenever you update your app, just run this command again.
