...
You can also change the default value of the component by setting the `value` parameter. To see a list of all the components Gradio supports and what attributes you can use to customize them, check out the [Docs](https://gradio.app/docs).
