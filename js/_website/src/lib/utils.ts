...
export const gradio_templates = {
    'interface': () => import('/src/lib/templates/gradio/01_building-demos/01_interface.svx'),
	'chatinterface': () => import('/src/lib/templates/gradio/01_building-demos/02_chatinterface.svx'),
	'tabbedinterface': () => import('/src/lib/templates/gradio/01_building-demos/03_tabbedinterface.svx'),
	'blocks': () => import('/src/lib/templates/gradio/01_building-demos/04_blocks.svx'),
	'accordion': () => import('/src/lib/templates/gradio/02_blocks-layout/accordion.svx'),
	...
	'introduction': () => import('/src/lib/templates/gradio/03_components/01_introduction.svx'),
	'annotatedimage': () => import('/src/lib/templates/gradio/03_components/annotatedimage.svx'),
	...
	'checkbox': () => import('/src/lib/templates/gradio/03_components/checkbox.svx'),
	'checkboxgroup': () => import('/src/lib/templates/gradio/03_components/checkboxgroup.svx'),
	'clearbutton': () => import('/src/lib/templates/gradio/03_components/clearbutton.svx'),
	'code': () => import('/src/lib/templates/gradio/03_components/code.svx'),
	'colorpicker': () => import('/src/lib/templates/gradio/03_components/colorpicker.svx'),
	'dataframe': () => import('/src/lib/templates/gradio/03_components/dataframe.svx'),
	'dataset': () => import('/src/lib/templates/gradio/03_components/dataset.svx'),
	'downloadbutton': () => import('/src/lib/templates/gradio/03_components/downloadbutton.svx'),
	'dropdown': () => import('/src/lib/templates/gradio/03_components/dropdown.svx'),
	'duplicatebutton': () => import('/src/lib/templates/gradio/03_components/duplicatebutton.svx'),
	'file': () => import('/src/lib/templates/gradio/03_components/file.svx'),
	'fileexplorer': () => import('/src/lib/templates/gradio/03_components/fileexplorer.svx'),
	'gallery': () => import('/src/lib/templates/gradio/03_components/gallery.svx'),
	'highlightedtext': () => import('/src/lib/templates/gradio/03_components/highlightedtext.svx'),
	'html': () => import('/src/lib/templates/gradio/03_components/html.svx'),
	'image': () => import('/src/lib/templates/gradio/03_components/image.svx'),
	'imageeditor': () => import('/src/lib/templates/gradio/03_components/imageeditor.svx'),
	'json': () => import('/src/lib/templates/gradio/03_components/json.svx'),
	'label': () => import('/src/lib/templates/gradio/03_components/label.svx'),
	'lineplot': () => import('/src/lib/templates/gradio/03_components/lineplot.svx'),
	'loginbutton': () => import('/src/lib/templates/gradio/03_components/loginbutton.svx'),
	'logoutbutton': () => import('/src/lib/templates/gradio/03_components/logoutbutton.svx'),
	'markdown': () => import('/src/lib/templates/gradio/03_components/markdown.svx'),
	'model3d': () => import('/src/lib/templates/gradio/03_components/model3d.svx'),
	'multimodaltextbox': () => import('/src/lib/templates/gradio/03_components/multimodaltextbox.svx'),
	'number': () => import('/src/lib/templates/gradio/03_components/number.svx'),
	'paramviewer': () => import('/src/lib/templates/gradio/03_components/paramviewer.svx'),
	'radio': () => import('/src/lib/templates/gradio/03_components/radio.svx'),
	'scatterplot': () => import('/src/lib/templates/gradio/03_components/scatterplot.svx'),
	...
	'uploadbutton': () => import('/src/lib/templates/gradio/03_components/uploadbutton.svx'),
	'video': () => import('/src/lib/templates/gradio/03_components/video.svx'),
	'simpleimage': () => import('/src/lib/templates/gradio/03_components/simpleimage.svx'),
	'set_static_paths': () => import('/src/lib/templates/gradio/04_helpers/set_static_paths.svx'),
	...
	'make_waveform': () => import('/src/lib/templates/gradio/04_helpers/make_waveform.svx'),
	...
	'mount_gradio_app': () => import('/src/lib/templates/gradio/06_routes/mount_gradio_app.svx'),
...
export const python_client_templates = {
	'introduction': () => import('/src/lib/templates/python-client/gradio_client/01_introduction.svx'),
	'client': () => import('/src/lib/templates/python-client/gradio_client/client.svx'),
