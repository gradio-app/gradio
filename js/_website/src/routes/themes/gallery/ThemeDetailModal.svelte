...
>
	...
	<div class="flex justify-center gap-3 shrink-0 pt-2">
		...
		<a
			href="/themes/builder"
			class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors bg-orange-500 text-white hover:bg-orange-600"
		>
			<svg
				class="w-4 h-4"
				fill="none"
