			...
			>
				...
				{#if show_nav}
					...
					<button
						...
						class:current-playground-demo={current_selection == "Ask AI"}
						class:shared-link={shared == "Ask AI"}
						class="mt-2 mx-4 mr-2 inline-block block bg-gradient-to-r from-orange-100 to-orange-50 border border-orange-200 px-4 py-0.5 rounded-full text-orange-800 w-fit hover:shadow"
						href="./storybook"
					>
						Ask AI &rarr;
					</button>
