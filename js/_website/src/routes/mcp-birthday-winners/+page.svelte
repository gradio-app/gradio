...
<div class="container mx-auto px-4 relative pt-8 mb-0">
	...
	>
		...
		<div
			class="relative mb-2 flex items-center text-lg font-semibold dark:text-gray-100"
		>
			<span>🛡️ Cite-Before-Act MCP</span>
		</div>
		<code class="font-light text-md mb-2 dark:text-gray-300"
			>bisonnetworking</code
		>
		<div class="relative pr-4 text-lg font-light dark:text-gray-200">
	...
	<div class="flex flex-col lg:flex-row gap-5">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">alihmaou</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">BrianIsaac</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">ArturoNereu</code
			>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
...
<div class="container mx-auto px-4 relative pt-8 mb-0">
	...
	<div class="flex flex-col lg:flex-row gap-5">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">chenglu</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">waroca</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">mashrur950</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
	...
	>
		...
		<code class="font-light text-md mb-2 dark:text-gray-300">owenkaplinsky</code
		>
		<div class="relative pr-4 text-lg font-light dark:text-gray-200">
	...
	<div class="flex flex-col lg:flex-row gap-5">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">akirahrkw</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
		...
		>
			...
			<code class="font-light text-md mb-2 dark:text-gray-300">nextmarte</code>
			<div class="relative pr-4 text-lg font-light dark:text-gray-200">
...
<div class="container mx-auto px-4 relative pt-8 mb-0">
	...
	<h1 class="mb-8 flex items-center text-xl align-middle font-light right-0">
	...
	>
		...
		<code class="font-light text-md mb-2 dark:text-gray-300">naazimsnh02</code>
		<div class="relative pr-4 text-lg font-light dark:text-gray-200">
	...
	>
		...
		<code class="font-light text-md mb-2 dark:text-gray-300">bhupesh-sf</code>
		<div class="relative pr-4 text-lg font-light dark:text-gray-200">
	...
	>
		...
		<code class="font-light text-md mb-2 dark:text-gray-300">Wildstash</code>
		<div class="relative pr-4 text-lg font-light dark:text-gray-200">
