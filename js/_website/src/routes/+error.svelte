...
<div class="flex-1 m-auto">
    ...
    <h1 class="error-code m-auto max-w-xl text-4xl font md:text-6xl pb-4 z-10 relative">{$page.status}</h1>
       <h2 class="mx-auto max-w-xl text-2xl text-gray-500 md:text-4xl z-10 relative">{$page.error.message}</h2>
