...
<Story name="Basic Checkbox Group" args={{
	value: ["swim", "run"],
	choices: [
		["Run", "run"],
		["Swim", "swim"],
...
<Story name="CheckboxGroup with info" args={{
	value: ["swim"],
	choices: [
		["Run", "run"],
		["Swim", "swim"],
...
<Story name="CheckboxGroup with select all" args={{
	value: ["run"],
	choices: [
		["Run", "run"],
		["Swim", "swim"],
...
<Story name="CheckboxGroup without label" args={{
	value: ["swim", "run"],
	choices: [
		["Run", "run"],
		["Swim", "swim"],
...
<Story name="CheckboxGroup disabled" args={{
	value: ["swim", "run"],
	choices: [
		["Run", "run"],
		["Swim", "swim"],
...
<Story name="CheckboxGroup with many options" args={{
...
<Story name="CheckboxGroup with different display and internal values" args={{
