...
// type EraseOptions = Omit<DrawOptions, "color">;
// export function erase_path(
// 	container: Container,
// 	renderer: IRenderer,
// 	stage: Container,
// 	width: number,
...
// 	renderer.render(container, { renderTexture: render_texture });
// 	const sprite = new Sprite(render_texture);
// 	const erase_filter = new Filter(undefined, erase_shader, {
// 		erasePosition: [0.5, 0.5],
// 		eraseRadius: 0.2
// 	});
// 	sprite.filters = [erase_filter];
...
// 	const paths: PathOptions[] = [];
// 	let initial_path: EraseOptions;
// 	// let eraser = new Graphics();
// 	// eraser.beginFill(0xffffff); // the color doesn't matter for a mask

// 	// eraser.drawRect(0, 0, width, height);
// 	// eraser.endFill();

// 	function update_eraser(x: number, y: number, radius: number): void {
// 		console.log({
// 			radius: radius / width,
// 			x: x / width,
// 			y: y / height
// 		});
// 		erase_filter.uniforms.erasePosition = [0.5, 0.5];
// 		erase_filter.uniforms.eraseRadius = 100 / width;
// 	}
...
// 	return {
// 		drawing: false,
// 		start: function ({ x, y, size, opacity }: EraseOptions) {
// 			console.log("start");
// 			initial_path = { x, y, size, opacity };
// 			paths.push({ x, y });

// 			update_eraser(x, y, size);
// 			console.log("FINSIGED");
// 			// renderer.render(stage);
...
// 			}
// 			// erase_circle(eraser, x, y, size);
// 			//@ts-ignore

// 			// container.mask = eraser;
...
// 			for (let i = 0; i < new_points.length; i++) {
// 				const { x, y } = new_points[i];
// 				update_eraser(x, y, initial_path.size);
// 				// renderer.render(stage);
