<script context="module" lang="ts">
	export { default as BaseRobotViewer } from "./shared/RobotViewer.svelte";
	export { default as BaseRobotViewerUpload } from "./shared/RobotViewerUpload.svelte";
	export { default as BaseExample } from "./Example.svelte";
</script>

<script lang="ts">
	import { tick } from "svelte";
	import type { RobotViewerProps, RobotViewerEvents } from "./types";
	import type { FileData } from "@gradio/client";
	import { Gradio } from "@gradio/utils";
	import RobotViewer from "./shared/RobotViewer.svelte";
	import RobotViewerUpload from "./shared/RobotViewerUpload.svelte";
	import { BlockLabel, Block, Empty, UploadText } from "@gradio/atoms";
	import { File } from "@gradio/icons";
	import { StatusTracker } from "@gradio/statustracker";

	class RobotViewerGradio extends Gradio<
		RobotViewerEvents,
		RobotViewerProps
	> {
		async get_data() {
	...
	const props = $props();
	const gradio = new RobotViewerGradio(props);
	...
	>
		...
		{#if gradio.props.value && is_browser}
			<RobotViewer
				...
				joint_states={gradio.props.joint_states}
				...
				show_joint_names={gradio.props.show_joint_names}
				i18n={gradio.i18n}
		...
		{:else}
			<BlockLabel
				show_label={gradio.shared.show_label}
				Icon={File}
				label={gradio.shared.label || "Robot Viewer"}
			/>
