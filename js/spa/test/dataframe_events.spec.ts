...
test.fixme("Dataframe change events work as expected", async ({ page }) => {
...
test.fixme("Dataframe blur event works as expected", async ({ page }) => {
...
test.fixme(
	"Dataframe filter functionality works correctly",
	async ({ page }) => {
		await page.getByRole("button", { name: "Update dataframe" }).click();
		await page.waitForTimeout(500);
...
test.fixme(
	"Dataframe search functionality works correctly",
	async ({ page }) => {
		await page.getByRole("button", { name: "Update dataframe" }).click();
		await page.waitForTimeout(500);
...
test.fixme("Tall dataframe has vertical scrolling", async ({ page }) => {
	await page.getByRole("button", { name: "Update dataframe" }).click();
	await page.waitForTimeout(500);
...
test.fixme(
	"Dataframe can be cleared and updated indirectly",
	async ({ page }) => {
...
test.fixme("Non-interactive dataframe cannot be edited", async ({ page }) => {
	await page.getByRole("button", { name: "Update dataframe" }).click();
	await page.waitForTimeout(500);
...
test.fixme(
	"Dataframe keyboard operations work as expected",
	async ({ page }) => {
		const df = page.locator("#dataframe").first();
...
test.fixme("Dataframe shift+click selection works", async ({ page }) => {
	const df = page.locator("#dataframe").first();
...
test.fixme("Dataframe cmd + click selection works", async ({ page }) => {
	const df = page.locator("#dataframe").first();
...
test.fixme("Static columns cannot be edited", async ({ page }) => {
...
test.fixme(
	"Dataframe search functionality works correctly after data update",
	async ({ page }) => {
...
test.fixme(
	"Dataframe displays custom display values with medal icons correctly",
	async ({ page }) => {
		await page.getByRole("button", { name: "Update dataframe" }).click();
		await page.waitForTimeout(500);
...
test.fixme("Dataframe select events work as expected", async ({ page }) => {
...
test.fixme(
	"Dataframe static columns cannot be cleared with Delete key",
	async ({ page }) => {
		const df = page.locator("#dataframe");
...
test.fixme("Dataframe keyboard events allow newlines", async ({ page }) => {
	await page.getByRole("button", { name: "Update dataframe" }).click();
	await page.waitForTimeout(500);
