...
test("Image Editor reshapes image to fit small unfixed 100 x 100 canvas", async ({ page }) => {
...
test("Image Editor reshapes image to fit fixed 500 x 500 canvas", async ({ page }) => {
    await page.locator("#small >> .upload-container > button").click();
