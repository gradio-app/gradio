<script lang="ts">
	...
	// Add this function to determine text alignment
	function get_text_align(is_user: boolean, is_rtl: boolean) {
		if (is_user) {
	...
	>
		{#each messages as message, thought_index}
			<div
				...
				style:text-align={get_text_align(role === "user", rtl)}
