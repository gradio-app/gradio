...
<Story name="Chatbot with math enabled" args={{
...
<Story name="Chatbot with math disabled, small height" args={{
	latex_delimiters: [],
	height: 200,
...
<Story name="Chatbot with math disabled, small max_height" args={{
	latex_delimiters: [],
	max_height: 200,
	value: defaultValue
}}>
...
<Story name="Chatbot with text rendered right-to-left" args={{
	rtl: true,
	latex_delimiters: [{ left: "$$", right: "$$", display: true }],
	value: [
		{
...
<Story name="Chatbot with panel layout enabled and avatars" args={{
...
<Story name="Chatbot with bubble layout enabled and avatars" args={{
	layout: "bubble",
	avatar_images: [
		{ url: "https://avatars.githubusercontent.com/u/100000?v=4" },
		{ url: "https://avatars.githubusercontent.com/u/100000?v=4" }
...
<Story name="Chatbot with percentage height" args={{
	layout: "panel",
	height: "50%",
	value: defaultValue
}}>
...
<Story name="Chatbot with placeholder" args={{
	value: [],
...
<Story name="Chatbot with headers and lists" args={{
	value: [
		{
			role: "user",
			content: [
...
<Story name="Chatbot with tables and nested lists" args={{
	value: [
		{
			role: "user",
			content: [
...
<Story name="Chatbot with image in markdown" args={{
	value: [
		{
			role: "user",
			content: [
...
<Story name="Uploaded text files" args={{
	type: "messages",
	value: [
		{
			role: "user",
...
<Story name="Consecutive messages grouped in same bubble" args={{
	type: "messages",
...
<Story name="MultimodalChatbot with examples" args={{
	value: [],
	examples: [
		{
...
<Story name="Consecutive messages not grouped in same bubble" args={{
	type: "messages",
...
<Story name="Chatbot with examples (not multimodal)" args={{
	value: [],
	examples: [
		{
			text: "What is machine learning?"
...
<Story name="Displaying Tool Message" args={{
	type: "messages",
	display_consecutive_in_same_bubble: true,
	value: [
		{
