...
class WorkflowCanvas(BlockContext, Component):
    """
    Creates a component with arbitrary WorkflowCanvas. Can include CSS and JavaScript to create highly customized and interactive components.
    Example:
        ```python
        import gradio as gr
        ...
        ```
    Demos: super_html
    Guides: custom-WorkflowCanvas-components, custom-CSS-and-JS
    """
    ...
    def __init__(
        ...
        **props: Any,
        ...
        """
        Parameters:
            value: The WorkflowCanvas content in the ${value} tag in the html_template. For example, if html_template="<p>${value}</p>" and value="Hello, world!", the component will render as `"<p>Hello, world!</p>"`.
            ...
            elem_id: An optional string that is assigned as the id of this component in the WorkflowCanvas DOM. Can be used for targeting CSS styles.
            elem_classes: An optional list of strings that are assigned as the classes of this component in the WorkflowCanvas DOM. Can be used for targeting CSS styles.
            ...
            min_height: The minimum height of the component, specified in pixels if a number is passed, or in CSS units if a string is passed. If WorkflowCanvas content exceeds the height, the component will expand to fit the content.
            ...
            container: If True, the WorkflowCanvas component will be displayed in a container. Default is False.
            padding: If True, the WorkflowCanvas component will have a certain padding (set by the `--block-padding` CSS variable) in all directions. Default is False.
            ...
            props: Additional keyword arguments to pass into the WorkflowCanvas and CSS templates for rendering.
        """
    ...
    def preprocess(self, payload: str | None) -> str | None:
        """
        Parameters:
            payload: string corresponding to the WorkflowCanvas
        Returns:
            (Rarely used) passes the WorkflowCanvas as a `str`.
        """
        return payload
    ...
    def postprocess(self, value: str | None) -> str | None:
        """
        Parameters:
            value: Expects a `str` consisting of valid WorkflowCanvas.
        Returns:
            Returns the WorkflowCanvas string.
        """
        return value
    ...
    def get_config(self) -> dict[str, Any]:  # type: ignore[override]
        if type(self) is not WorkflowCanvas:
            config = {
                **super().get_config(),
                **super().get_config(WorkflowCanvas),
            }
        else:
            config = super().get_config()
        # For custom WorkflowCanvas components, we use the component_class_name
    ...
    def _to_publish_format(
        ...
        """Convert this WorkflowCanvas component to the format expected by the WorkflowCanvas Components Gallery
    ...
    def push_to_hub(
        ...
        """Push this WorkflowCanvas component to the WorkflowCanvas Components Gallery as a pull request.
        ...
        Parameters:
            name: Display name for the component. Defaults to the class name (for subclasses) or label.
            head: Raw WorkflowCanvas to inject into `<head>` (e.g. external scripts). Only needed if your component expects a `<head>` script to be added by the parent Gradio application.
            description: Short description of what the component does.
