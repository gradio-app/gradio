...
export declare const SPACE_FETCHER_URL =
  "https://gradio-space-api-fetcher-v2.hf.space/api";
export declare const SPACE_URL = "https://hf.space/{}";
export declare const QUEUE_FULL_MSG =
