...
export declare function process_endpoint(
...
export declare function transform_api_info(
...
export declare function get_description(
  type: {
    type: any;
    description: string;
  },
...
export declare function handle_message(
  data: any,
 ...
 */
export declare const map_data_to_params: (
